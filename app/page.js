  ...
  return (
    <div className="container">
      <section className="section-padding" style={{ textAlign: 'center' }}>
        <h1 className="hero-title" style={{ fontSize: '56px', marginBottom: '20px', lineHeight: 1.05 }}>
          Para los amantes del buen comer.
        </h1>
        <p className="hero-subtitle" style={{ fontSize: '24px', color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto 40px' }}>
      ...
      <section>
        <div className="glass feature-card" style={{ borderRadius: '24px', padding: '60px', textAlign: 'center' }}>
          <h2 className="feature-title" style={{ fontSize: '40px', marginBottom: '16px' }}>Exclusivo. Elegante. Sabroso.</h2>
          <p className="feature-subtitle" style={{ color: 'var(--text-secondary)', fontSize: '19px' }}>
